...
export const ActionTypes = {
    ...
    FIX_DESCRIPTIONS_BEGIN: "FIX_DESCRIPTIONS_BEGIN",
    FIX_DESCRIPTIONS_DESCRIPTION_FIXED: "FIX_DESCRIPTIONS_DESCRIPTION_FIXED",
    FIX_DESCRIPTIONS_SUCCESS: "FIX_DESCRIPTIONS_SUCCESS",
    FIX_DESCRIPTIONS_FAILURE: "FIX_DESCRIPTIONS_FAILURE",
};
